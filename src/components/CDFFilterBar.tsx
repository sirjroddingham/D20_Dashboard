...
import { useUniqueEmployees, CDF_DEFECT_COLUMNS, CDF_DEFECT_LABELS, type CDFFilterState } from '../store/useCDFStore';
import type { CDFRow } from '../lib/cdf/types';

interface CDFFilterBarProps {
  filters: CDFFilterState;
  rows: CDFRow[];
  dateRange: { min: string; max: string };
  onFilterChange: (filters: Partial<CDFFilterState>) => void;
}

export default function CDFFilterBar({ filters, rows, dateRange, onFilterChange }: CDFFilterBarProps) {
  const employees = useUniqueEmployees(rows);
